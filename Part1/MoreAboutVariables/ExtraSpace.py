...
# The code works almost correctly, but not quite. This exercise has very strict tests, which check the output
# for every single bit of whitespace.
...
# into your string.
# Do remember to be extra careful when formatting printouts also in the future on this course. Some of the
# exercises have tests that require your output to be exactly as specified in the examples given. For example,
# please use actual whitespace characters in your code, instead of ASCII character codes for whitespace, or
# some such.
# Note: The string inside print statement in python will be dislayed on one line. If te string is longer
# than the line, the string will be cut with characters reaching the end of the line.
name = "Tim Tester"
age = 20
skill1 = "python"
level1 = "beginner"
