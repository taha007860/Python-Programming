# The following program contains several syntactic errors. Please fix the program so that the syntax is in
# order and the program works as specified by the examples below.
