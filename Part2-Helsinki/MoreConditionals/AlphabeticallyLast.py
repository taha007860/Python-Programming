...
# alphabetically before b. Notice however that the comparison is only reliable if the characters compared are of the
# same case, i.e. both UPPERCASE or both lowercase only the standard English alphabet of a to z, or A to Z, is used.
